...
func get1DiagResult(fld *Field,k int,l int)(bool,*ResultQueue){
	x0 := int(math.Max(0,math.Max(float64(k-l),float64(k-5))))
	x1 := int(math.Min(float64(k+5),FIELD_SIZE))
	y0 := int(math.Max(0,math.Max(float64(l-k),float64(l-5))))
...
func get2DiagResult(fld *Field,k int,l int)(bool,*ResultQueue){
	x0 := int(math.Max(0,math.Max(float64(k-l),float64(k-5))))
	x1 := int(math.Min(float64(k+5),FIELD_SIZE))
	y1 := int(math.Max(-1,math.Max(float64(l-k),float64(l-5))))
	y0 := int(math.Min(float64(l+5),FIELD_SIZE-1))
