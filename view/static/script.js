...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    initHooks_closure0: {
      "^": "Closure:15;_captured_getUnknownTag_1",
    ...
    Element: {
      "^": "Node;id=,_innerHtml:innerHTML},tagName=",
    ...
    HttpRequest_postFormData_closure: {
      "^": "Closure:3;_captured_parts_0",
      call$2: function(key, value) {
        this._captured_parts_0.push(P.Uri__uriEncode(C.List_nxB, key, C.Utf8Codec_false, true) + "=" + P.Uri__uriEncode(C.List_nxB, value, C.Utf8Codec_false, true));
      }
    },
    ...
    _ElementCssClassSet: {
      ...
      remove$1: function(_, value) {
        return W._ElementCssClassSet__remove(this._html$_element, value);
      },
      static: {_ElementCssClassSet__remove: function(_element, value) {
          var list, removed;
    ...
    _Html5NodeValidator: {
      ...
      static: {_Html5NodeValidator$: function(uriPolicy) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 14], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          var t1, t2, t3, t4, t5;
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 14]}
    },
    ImmutableListMixin: {
      "^": "Object;",
      get$iterator: function(receiver) {
    ...
    register: [function(e) {
      ...
      form = H.interceptedTypeCast(W._convertNativeToDart_EventTarget(e.target), "$isFormElement");
      url = form.getAttribute("action");
      P.print(url);
      $name = H.interceptedTypeCast(form.querySelector("input#clientNameField"), "$isInputElement").value;
      data = P.LinkedHashMap__makeLiteral(["name", $name]);
      P.print(url);
      P.print(url);
      W.HttpRequest_postFormData(url, data, null, null, null, null).then$1(new N.register_closure($name));
    }, "call$1", "script__register$closure", 2, 0, 4],
    createCookie: function($name, value, days) {
      var expires = days != null ? "; expires=" + P.DateTime$fromMillisecondsSinceEpoch(Date.now() + C.JSInt_methods._tdivFast$1(P.Duration$(days, 0, 0, 0, 0, 0)._duration, 1000), false).toString$0(0) : "; expires=" + new P.DateTime(Date.now(), false).toString$0(0);
      document.cookie = C.JSString_methods.$add($name + "=", value) + expires + "; path=/";
    },
    readCookie: function($name) {
      ...
      for (i = 0; i < ca.length; ++i) {
        ...
        if (C.JSString_methods.indexOf$1(c, nameEQ) === 0)
          return C.JSString_methods.substring$1(c, nameEQ.length);
      }
      return;
    },
    getClientName: function() {
      var clName, t1;
      clName = N.readCookie("clientName");
      if (clName != null) {
        t1 = document.querySelector("#registr").style;
        t1.display = "none";
        document.querySelector("#play").setAttribute("style", "");
        J.set$innerHtml$x(document.querySelector("#login_name"), clName);
        document.querySelector("#logout").setAttribute("style", "");
        t1 = P.Timer_Timer$periodic(C.Duration_2000000, N.script__updatePlayers$closure());
        $.timer = t1;
        ...
        t1 = document.querySelector("#play").style;
        t1.display = "none";
        document.querySelector("#registr").setAttribute("style", "");
        J.set$innerHtml$x(document.querySelector("#login_name"), "");
        t1 = document.querySelector("#logout").style;
        t1.display = "none";
      }
    },
    logout: [function($event) {
      ...
      el = H.interceptedTypeCast(W._convertNativeToDart_EventTarget($event.target), "$isAnchorElement");
      P.print(el.innerHTML);
      url = el.getAttribute("href");
      W.HttpRequest_getString(url, null, null).then$1(new N.logout_closure(url));
    }, "call$1", "script__logout$closure", 2, 0, 4],
    updatePlayers: [function(timer) {
      W.HttpRequest_getString("/updatePlayers", null, null).then$1(new N.updatePlayers_closure(new N.updatePlayers_setClickable()));
    }, "call$1", "script__updatePlayers$closure", 2, 0, 23],
    openSocket: function() {
      var socket, t1;
    ...
    displayResult: function(msg) {
      ...
      if (1 >= t1.length)
        return H.ioore(t1, 1);
      field_vals = J.split$1$s(t1[1], ";");
      for (k = 0; k < 5; ++k) {
        if (k >= field_vals.length)
          return H.ioore(field_vals, k);
        i_j = J.split$1$s(field_vals[k], ",");
        t1 = i_j.length;
        if (0 >= t1)
          return H.ioore(i_j, 0);
        i = i_j[0];
        if (1 >= t1)
          return H.ioore(i_j, 1);
        j = i_j[1];
        t1 = C.JSString_methods.$add(C.JSString_methods.$add("#", i) + "x", j);
    ...
    updateTable: function() {
      W.HttpRequest_getString("/getTable", null, null).then$1(new N.updateTable_closure());
    },
    register_closure: {
      "^": "Closure:6;_captured_name_0",
      call$1: function(request) {
        var t1 = this._captured_name_0;
        N.createCookie("clientName", t1, 1);
        P.print(t1);
        N.getClientName();
        $.socket = N.openSocket();
      }
    ...
    logout_closure: {
      "^": "Closure:5;_captured_url_0",
      call$1: function(resp) {
        var t1;
        N.getClientName();
        t1 = this._captured_url_0;
        P.print(t1);
        $.timer.cancel$0();
        P.print(t1);
        $.socket.close();
    ...
    updatePlayers_setClickable: {
      "^": "Closure:2;",
      call$0: function() {
        var t1 = new W._FrozenElementList(document.querySelectorAll(".players_free"));
        t1.forEach$1(t1, new N.updatePlayers_setClickable_closure());
      }
    },
    updatePlayers_setClickable_closure: {
      "^": "Closure:1;",
      call$1: function(playerButton) {
        J.get$onClick$x(playerButton).listen$1(new N.updatePlayers_setClickable__requestToPlay(playerButton));
      }
    },
    updatePlayers_setClickable__requestToPlay: {
      "^": "Closure:4;_captured_playerButton_0",
      call$1: function(e) {
        var clName, $content, t1;
        clName = N.readCookie("clientName");
        $content = J.get$innerHtml$x(J.querySelector$1$x(this._captured_playerButton_0, "a"));
        t1 = $.socket;
        if ($content == null)
          return $content.$add();
        t1.send(C.JSString_methods.$add($content + "%", clName) + ":clientToApprove");
      }
    },
    updatePlayers_closure: {
      "^": "Closure:5;_captured_setClickable_1",
      call$1: function(resp) {
        J.set$innerHtml$x(document.querySelector("#active_players"), resp);
        this._captured_setClickable_1.call$0();
      }
    },
    openSocket_closure: {
    ...
    openSocket_closure0: {
      ...
      call$1: function($event) {
        if (J.get$wasClean$x($event) === true)
          P.print("\u0421\u043e\u0435\u0434\u0438\u043d\u0435\u043d\u0438\u0435 \u0437\u0430\u043a\u0440\u044b\u0442\u043e \u0447\u0438\u0441\u0442\u043e");
        else
          P.print("\u041e\u0431\u0440\u044b\u0432 \u0441\u043e\u0435\u0434\u0438\u043d\u0435\u043d\u0438\u044f");
        P.print(C.JSString_methods.$add("\u041a\u043e\u0434: " + J.toString$0$($event.code) + " \u043f\u0440\u0438\u0447\u0438\u043d\u0430: ", $event.reason));
      }
    },
    openSocket_closure1: {
      ...
      call$1: function($event) {
        ...
        msg = t1.get$data($event);
        P.print(t1.get$data($event));
        t1 = J.split$1$s(msg, ":");
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        if (J.$eq$(t1[0], "ConfirmClient")) {
          t1 = msg.split(":");
          if (1 >= t1.length)
            return H.ioore(t1, 1);
          enemy = t1[1];
        ...
        if (J.$eq$(t1[0], "IsCross")) {
          ...
          if (1 >= t1.length)
            return H.ioore(t1, 1);
          turn = t1[1];
          P.print(C.JSString_methods.$add("turn=", turn));
          $.isTurn = J.$eq$(turn, "true");
          J.set$innerHtml$x(document.querySelector("#field"), new N.openSocket__generateTable().call$1(N.readCookie("enemyName")));
          t1 = J.get$onClick$x(document.querySelector("#quit_button"));
          H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.script__quit$closure()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
          if ($.isTurn) {
        ...
        if (J.$eq$(t1[0], "MadeStep")) {
          ...
          $.$get$listeners().forEach$1(0, new N.openSocket__cancelClick(id_val));
        }
        t1 = msg.split(":");
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        if (J.$eq$(t1[0], "YouWon")) {
          N.displayResult(msg);
          J.set$innerHtml$x(document.querySelector("#won_cond"), "You won!");
          $.$get$listeners().forEach$1(0, new N.openSocket__closure3());
          $.listeners = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [P.String, P.StreamSubscription]);
        }
        t1 = msg.split(":");
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        if (J.$eq$(t1[0], "YouLose")) {
          N.displayResult(msg);
          J.set$innerHtml$x(document.querySelector("#won_cond"), "You lose");
          $.$get$listeners().forEach$1(0, new N.openSocket__closure4());
          $.listeners = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [P.String, P.StreamSubscription]);
        }
        t1 = msg.split(":");
        if (0 >= t1.length)
    ...
    openSocket__generateTable: {
      "^": "Closure:22;",
      call$1: function(enemy) {
        var table, i, j;
        table = C.JSString_methods.$add("<div>Your enemy:", enemy) + "</div><div id=\"which_turn\">";
        P.print($.isTurn);
        table = table + ($.isTurn ? "Your turn" : "Your opposite`s turn") + "</div><div id='quit_button'><a href=\"#\">Quit</a></div><div id=\"won_cond\"></div><table><tbody>";
        for (i = 0; i < 10; ++i) {
          table += "<tr>";
          for (j = 0; j < 10; ++j)
            table = table + "<td class=\"active-rows table_rows\" " + (" id=\"" + C.JSInt_methods.toString$0(i) + "x" + C.JSInt_methods.toString$0(j) + "\" ></td>");
          table += "</tr>";
        }
    ...
    openSocket__madestep: {
      ...
      call$1: function(e) {
        var el, t1;
        el = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement");
        t1 = el && C.InputElement_methods;
        if ($.isCross)
          t1.setInnerHtml$1(el, "X");
        else
          t1.setInnerHtml$1(el, "O");
        W._ElementCssClassSet__remove(el, "active-rows");
        $.isTurn = !$.isTurn;
        t1 = document.querySelector("#which_turn");
        J.set$innerHtml$x(t1, $.isTurn ? "Your Turn" : "Opposite's turn");
    ...
    openSocket__madestep_closure: {
      "^": "Closure:3;",
      call$2: function(numb, listener) {
        return listener.cancel$0();
      }
    },
    ...
    openSocket___drawCellInnerElement: {
      ...
      call$1: function(e) {
        ...
        t3.get$classes(t1).remove$1(0, "active-rows");
        $.isTurn = !$.isTurn;
        t3 = document.querySelector("#which_turn");
        J.set$innerHtml$x(t3, $.isTurn ? "Your Turn" : "Opposite's turn");
        $.$get$listeners().forEach$1(0, new N.openSocket___drawCellInnerElement_cancelClick(t1));
        t1 = t1.id;
        if (t1 == null)
          return t1.$add();
    ...
    openSocket___drawCellInnerElement_cancelClick: {
      "^": "Closure:13;_captured_row_13",
      call$2: function(id, listener) {
        if (J.$eq$(id, this._captured_row_13.id)) {
          listener.cancel$0();
          $.$get$listeners().remove$1(0, id);
          return;
        }
      }
    },
    openSocket___closure: {
      "^": "Closure:0;_captured_row_14,_captured_drawCellInnerElement_15",
      call$0: function() {
        return J.get$onClick$x(this._captured_row_14).listen$1(this._captured_drawCellInnerElement_15);
      }
    },
    openSocket__cancelClick: {
      "^": "Closure:13;_captured_id_val_16",
      call$2: function(id, listener) {
        if (J.$eq$(id, this._captured_id_val_16)) {
          listener.cancel$0();
          $.$get$listeners().remove$1(0, id);
          return;
        }
    ...
    openSocket__closure4: {
      "^": "Closure:3;",
      call$2: function(numb, listener) {
        return listener.cancel$0();
      }
    },
    openSocket__closure5: {
      "^": "Closure:3;",
      call$2: function(numb, listener) {
        return listener.cancel$0();
      }
    ...
    updateTable_closure: {
      ...
      call$1: function(resp) {
        var t1;
        document.querySelector("#field").setAttribute("style", "");
        J.set$innerHtml$x(document.querySelector("#field"), resp);
        t1 = J.get$onClick$x(document.querySelector("#quit_button"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.script__quit$closure()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        if ($.isTurn) {
          t1 = new W._FrozenElementList(document.querySelectorAll("#active-rows"));
          t1.forEach$1(t1, new N.updateTable__closure(new N.updateTable__madestep()));
        }
      }
    },
    updateTable__madestep: {
      "^": "Closure:4;",
      call$1: function(e) {
        var el, t1, t2;
        el = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement");
        ...
        t1 = document.querySelector("#which_turn");
        J.set$innerHtml$x(t1, $.isTurn ? "Your Turn" : "Opposite's turn");
        $.$get$listeners().forEach$1(0, new N.updateTable__madestep_closure());
        $.listeners = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [P.String, P.StreamSubscription]);
        t1 = $.socket;
        t2 = el.id;
        if (t2 == null)
    ...
    updateTable__madestep_closure: {
      "^": "Closure:3;",
      call$2: function(numb, listener) {
        return listener.cancel$0();
      }
    },
    updateTable__closure: {
      "^": "Closure:1;_captured_madestep_0",
      call$1: function(cell) {
        var t1, $onclick;
        t1 = J.getInterceptor$x(cell);
        $onclick = t1.get$onClick(cell);
        $.$get$listeners().putIfAbsent$2(t1.get$id(cell), new N.updateTable___closure(this._captured_madestep_0, $onclick));
      }
    },
    updateTable___closure: {
      "^": "Closure:0;_captured_madestep_1,_captured_onclick_2",
      call$0: function() {
        return this._captured_onclick_2.listen$1(this._captured_madestep_1);
      }
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  J.get$wasClean$x = function(receiver) {
    return J.getInterceptor$x(receiver).get$wasClean(receiver);
  };
...
;
  ...
  }, "listeners", "$get$listeners", "listeners", function() {
    return H.JsLinkedHashMap_JsLinkedHashMap$es6(P.String, P.StreamSubscription);
  }]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Event]}, {func: 1, args: [P.String]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [W.MouseEvent]}, {func: 1, v: true, args: [P.String, P.StreamSubscription]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, args: [W.CloseEvent]}, {func: 1, ret: P.String, args: [,]}, {func: 1, v: true, args: [P.Timer]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(N.script__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(N.script__main$closure(), a);
